...
| `specs/2026-07-01-localization-quality-language-expansion-design.md` | Superseded in scope | Earlier Phase 8 localization add-on; issue #28 expands the implemented scope to EN/RU/ZH/DE/FR/ES/AR with Arabic RTL QA. |
