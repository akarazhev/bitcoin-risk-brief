...
- [Data Pipeline](data-pipeline.md): canonical CSV source, optional CoinMarketCap API refresh, planned downloaded CSV intake, validation, import, and failure behavior.
