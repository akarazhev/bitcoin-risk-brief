...
- [Dependency and License Review](dependency-license-review.md): dated local dependency inventory, lockfile license metadata, container image references, and pending external/manual confirmations.
