...
- [Data Pipeline](data-pipeline.md): canonical CSV source, downloaded CoinMarketCap CSV intake, optional CoinMarketCap API refresh, validation, import, and failure behavior.
...
- [Operations](operations.md): local commands, downloaded CSV refresh, container lifecycle, database maintenance, backups, and troubleshooting.
