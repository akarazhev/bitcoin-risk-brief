...
- [Pilot Learning Loop](pilot-learning-loop.md): Phase 9 observation cadence, aggregate waitlist review, sanitized feedback summaries, decision criteria, and evidence packet template.
- [Marketing and Growth](marketing-and-growth.md): focused ICP, founder-led acquisition channels, EN/RU campaign assets, four-week scorecard, attribution limits, and promotion safeguards.
