...
type Copy = {
  ...
  developerLinksAriaLabel: string
  eyebrow: string
  title: string
  subtitle: string
  updated: string
...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    developerLinksAriaLabel: 'Developer and agent resources',
    ...
    waitlistBody: 'Band changes are rare. Leave an email to hear about one. This is a manual follow-up — automated delivery does not exist yet.',
    placeholder: 'your email',
    join: 'Register interest',
    joined: 'Saved. You will hear from us when the risk band changes.',
    joinError: 'Enter a valid email address.',
    joining: 'Saving...',
    ...
    privacyNoteWaitlist: 'The interest form stores the contact you submit, a normalized copy, contact type, locale, source, status, and timestamps.',
  ...
  ru: {
    ...
    developerLinksAriaLabel: 'Ресурсы для разработчиков и агентов',
    ...
    waitlistBody: 'Диапазон меняется редко. Оставьте email, чтобы узнать о смене. Это ручная связь — автоматической рассылки пока нет.',
    placeholder: 'ваш email',
    join: 'Оставить контакт',
    joined: 'Сохранено. Мы напишем, когда диапазон риска изменится.',
    joinError: 'Введите корректный email.',
    joining: 'Сохранение...',
    ...
    privacyNoteWaitlist: 'Форма интереса хранит введенный контакт, нормализованную копию, тип контакта, язык, источник, статус и временные метки.',
  ...
  zh: {
    ...
    developerLinksAriaLabel: '开发者和智能体资源',
    eyebrow: '每日 BTC 风险信号',
    title: 'Bitcoin Risk Brief',
    ...
    waitlistBody: '风险区间变化很少见。留下邮箱以便获知变化。这是人工联系，目前没有自动推送。',
    placeholder: '您的邮箱',
    join: '登记关注',
    joined: '已保存。风险区间变化时我们会联系您。',
    joinError: '请输入有效的邮箱地址。',
    joining: '保存中...',
    ...
    privacyNoteWaitlist: '此表单会存储您提交的联系方式、规范化副本、联系方式类型、语言、来源、状态和时间戳。',
  ...
  de: {
    ...
    developerLinksAriaLabel: 'Ressourcen für Entwickler und Agenten',
    ...
    waitlistBody: 'Bandwechsel sind selten. Hinterlassen Sie eine E-Mail, um davon zu erfahren. Das ist eine manuelle Rückmeldung — einen automatischen Versand gibt es noch nicht.',
    placeholder: 'Ihre E-Mail',
    join: 'Interesse hinterlegen',
    joined: 'Gespeichert. Wir melden uns, wenn das Risikoband wechselt.',
    joinError: 'Bitte geben Sie eine gültige E-Mail-Adresse ein.',
    joining: 'Speichern...',
    ...
    privacyNoteWaitlist: 'Das Interessenformular speichert den eingereichten Kontakt, eine normalisierte Kopie, Kontakttyp, Sprache, Quelle, Status und Zeitstempel.',
  ...
  fr: {
    ...
    developerLinksAriaLabel: 'Ressources pour développeurs et agents',
    ...
    waitlistBody: 'Les changements de bande sont rares. Laissez un e-mail pour en être informé. Il s’agit d’un suivi manuel — l’envoi automatique n’existe pas encore.',
    placeholder: 'votre e-mail',
    join: 'Signaler mon intérêt',
    joined: 'Enregistré. Nous vous écrirons lorsque la bande de risque changera.',
    joinError: 'Saisissez une adresse e-mail valide.',
    ...
    privacyNoteWaitlist: 'Le formulaire d’intérêt stocke le contact soumis, une copie normalisée, le type de contact, la langue, la source, le statut et les horodatages.',
  ...
  es: {
    ...
    developerLinksAriaLabel: 'Recursos para desarrolladores y agentes',
    ...
    waitlistBody: 'Los cambios de banda son poco frecuentes. Deja un correo para enterarte. Es un seguimiento manual: todavía no existe el envío automático.',
    placeholder: 'tu correo',
    join: 'Registrar interés',
    joined: 'Guardado. Te escribiremos cuando cambie la banda de riesgo.',
    joinError: 'Introduce un correo electrónico válido.',
    joining: 'Guardando...',
    ...
    privacyNoteWaitlist: 'El formulario de interés almacena el contacto enviado, una copia normalizada, tipo de contacto, idioma, fuente, estado y marcas de tiempo.',
  ...
  ar: {
    ...
    developerLinksAriaLabel: 'موارد المطورين والوكلاء',
    ...
    waitlistBody: 'تغيّر النطاق نادر. اترك بريدا إلكترونيا لتعرف بذلك. هذه متابعة يدوية — لا يوجد إرسال تلقائي بعد.',
    placeholder: 'بريدك الإلكتروني',
    join: 'تسجيل الاهتمام',
    joined: 'تم الحفظ. سنتواصل معك عند تغيّر نطاق المخاطر.',
    joinError: 'أدخل بريدا إلكترونيا صالحا.',
    joining: 'جار الحفظ...',
    ...
    privacyNoteWaitlist: 'يخزّن نموذج الاهتمام جهة الاتصال التي ترسلها، ونسخة موحدة منها، ونوع جهة الاتصال، واللغة، والمصدر، والحالة، والطوابع الزمنية.',
